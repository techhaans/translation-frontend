...
const RegisterProofreaderForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const proofreaderResponse = await fetch('https://api.techhaans.com/proof/register-proofreader', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
...
//     try {
//       const response = await fetch('https://api.techhaans.com/proof/register-proofreader', {
//         method: 'POST',
//         headers: { 'Content-Type': 'application/json' },
